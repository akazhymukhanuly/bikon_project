(function () {
  ...
  var DEFAULT_UI = {
    ru: {
      ...
      lead: "Здесь показаны ветви потомков, которые сейчас внесены в схему родословной.",
      note: "На схеме пока указана только часть потомков, в основном мужские линии. Счётчики выше считают только тех, кто уже внесён в дерево.",
      ...
      statsChildren: "ветвей детей",
      statsGrandchildren: "показано внуков",
      statsGreatGrandchildren: "показано правнуков",
      statsAllDescendants: "внесено в схему",
    ...
    kz: {
      ...
      lead: "Мұнда шежіреге қазір енгізілген ұрпақ тармақтары көрсетілген.",
      note: "Бұл сызбада әзірге ұрпақтардың бір бөлігі, негізінен ер балалар жағы ғана берілген. Жоғарыдағы сандар тек осы ағашқа енгізілген адамдарды есептейді.",
      ...
      statsChildren: "бала тармағы",
      statsGrandchildren: "көрсетілген немере",
      statsGreatGrandchildren: "көрсетілген шөбере",
      statsAllDescendants: "сызбаға енгені",
