(function () {
  ...
  var translations = {
    ru: {
      ...
      familyShowcaseEyebrow: "Семья",
      familyShowcaseTitle: "Семейный снимок, собравший близких рядом",
      familyShowcaseLead: "Эта фотография показывает не только людей в одном кадре, но и ту семейную связь, ради которой весь этот архив и сохраняется.",
      familyShowcaseAlt: "Семейная фотография",
      familyShowcaseCaption: "Семейный кадр, в котором особенно чувствуется продолжение рода и память, сохранённая в доме.",
      ...
      warWoundsEyebrow: "Военные документы",
      warWoundsTitle: "Документы о ранении на войне",
      warWoundsLead: "В этом блоке показаны архивные документы, подтверждающие сквозное пулевое ранение, полученное в годы войны.",
      warWoundOneAlt: "Документ о ранении, страница 1",
      warWoundOneTitle: "Справка о ранении",
      warWoundOneText: "Первый скан документа, где сохранена формулировка о сквозном пулевом ранении.",
      warWoundTwoAlt: "Документ о ранении, страница 2",
      warWoundTwoTitle: "Подтверждающий документ",
      warWoundTwoText: "Второй скан дополняет архивное свидетельство и показывает данные о боевой травме.",
    ...
    kz: {
      ...
      familyShowcaseEyebrow: "Отбасы",
      familyShowcaseTitle: "Жақындарды бір кадрға жинаған отбасылық сурет",
      familyShowcaseLead: "Бұл сурет бір кадрдағы адамдарды ғана емес, бүкіл мұрағатты сақтап тұрған отбасы байланысын да айқын көрсетеді.",
      familyShowcaseAlt: "Отбасылық сурет",
      familyShowcaseCaption: "Бұл кадрдан әулет жалғастығы мен үйде сақталған қастерлі естеліктің жылуы анық сезіледі.",
      timelineEyebrow: "Хронология",
      ...
      warWoundsEyebrow: "Соғыс құжаттары",
      warWoundsTitle: "Соғыстағы жарақат туралы құжаттар",
      warWoundsLead: "Бұл бөлімде соғыс жылдарында алған сквозной оқ жарақатын растайтын мұрағат құжаттары көрсетіледі.",
      warWoundOneAlt: "Жарақат туралы құжат, 1-бет",
      warWoundOneTitle: "Жарақат туралы анықтама",
      warWoundOneText: "Бірінші сканда сквозной оқ жарақаты туралы негізгі дерек сақталған.",
      warWoundTwoAlt: "Жарақат туралы құжат, 2-бет",
      warWoundTwoTitle: "Растайтын құжат",
      warWoundTwoText: "Екінші скан боевой жарақат туралы мәліметті толықтырады.",
